...
const GALLERIES: Record<string, { src: string; alt: string }[]> = {
  all: [
    { src: "/gallery/img1.webp", alt: "Rogue Ninja Training 1" },
    { src: "/gallery/img2.webp", alt: "Rogue Ninja Training 2" },
  ...
  battle: [
    { src: "/gallery/BATTLE FIELD/23cbaf83-a446-42b8-a818-f706389790ee.webp", alt: "Sparring Session" },
    { src: "/gallery/BATTLE FIELD/3c97c1d4-63a4-4b33-89e6-1847c1159c05.webp", alt: "Technique Drill" },
    { src: "/gallery/BATTLE FIELD/5801e596-d1ef-4d88-b9f3-6b64765aac65.webp", alt: "Live Fight" },
    { src: "/gallery/BATTLE FIELD/IMG_0730.webp", alt: "Battle Focus" },
  ],
  legends: [
    { src: "/gallery/HALL OF LEGENDS/43a6ba2b-7279-4aff-a06a-954f960f1472.webp", alt: "Champion Wall" },
    { src: "/gallery/HALL OF LEGENDS/5314dcaa-c110-44e4-b551-4f24c9c86f52.webp", alt: "Medal Ceremony" },
    { src: "/gallery/HALL OF LEGENDS/IMG_2411.webp", alt: "Legendary Moment" },
  ],
  crew: [
